...
function switch_to_external {
  ...
  su $username -c '/usr/bin/xrandr --output eDP1  --off --output DP1-1 --auto --output DP1-2 --auto'

  # Use laptop speaker
  su $username -c '/home/cspensky/projects/knowledge/scripts/set_sink_speaker.sh'
